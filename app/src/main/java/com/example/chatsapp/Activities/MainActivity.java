...
//                    ArrayList<Status> statuses =new ArrayList<>();
                    for (DataSnapshot storySnapshot : snapshot.getChildren()) {
                        ...
                        for(DataSnapshot statusSnapshot : storySnapshot.child("statues").getChildren()) {
                            Status sampleStatus = statusSnapshot.getValue(Status.class);
                            statuses.add(sampleStatus);
                        }

//                        Log.i("story", String.valueOf(statuses.size()));
//
...
//                                        Status imageUrl=new Status(imageUrl,userStatus.getLastUpdated());
